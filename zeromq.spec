...
%changelog
* Thu Jun  4 2015 Stepan Stipl <stepan@stipl.net> - 4.1.1-1
- Update to ZeroMQ 4.1.1 stable release.
- Added support for enforced libsodium
- Added dependency onb openpgm-devel
- Removed man pages from devel packes - doesn't seem to be there
